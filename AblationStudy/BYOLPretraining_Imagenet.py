...
save_dir = r"C:/Users/Xuxu/Desktop/Master Thesis/BYOLPretrainImagenet"
batch_size = 256
num_workers = 2
max_epochs = 100
lr = 0.0003
...
class BYOLConvNeXtTiny(pl.LightningModule):
    def __init__(self):
        super().__init__()
        base = torchvision.models.convnext_tiny(ights= torchvision.models.ConvNeXt_Tiny_Weights.IMAGENET1K_V1) # initiliaze with Imagenet-1k weights 
