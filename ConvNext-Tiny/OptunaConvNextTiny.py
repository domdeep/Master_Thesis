...
# convnexttiny with optuna hyperparameter tuning
import os
import random
import numpy as np
import json
...
# convnextiny with configurable classifier head and optimizer
...
def objective(trial, train_loader, val_loader, num_classes, fixed_class_weights, output_dir):
    ...
    checkpoint_callback = ModelCheckpoint(
        monitor="val_f1", save_top_k=1, mode="min",
...
def main():
    ...
    split_path = r"C:/Users/Xuxu/Desktop/Master Thesis/OptunaDensenetFull" 
    ...
    joblib.dump(study, os.path.join(output_dir, "new_convnext_study.pkl"))
